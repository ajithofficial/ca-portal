...
import { sidebarStructure } from "../constants/sidebar-structure";
...
const Sidebar: FC<SidebarProps> = ({ setExpand }) => {
  ...
  return (
    <nav
      role="navigation"
      className={[
        "relative z-10 bg-slate-50 border-r border-slate-100 shadow-sm absolute inset-y-0 left-0",
